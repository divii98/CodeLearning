...
ApplicationConfig {
    ...
    private final MetroCardRepository metroCardRepository = new MetroCardRepository();
    private final StationSummaryRepository stationSummaryRepository = new StationSummaryRepository();
    private final IStationService metroCardService = new StationService(metroCardRepository, stationSummaryRepository);
